...
const COMPONENTS = [
  ...
  { id: "Canule 00 ISO 5", name: "Canule 00 ISO 5", min: 1, max: 1 },
  { id: "Canule 01 ISO 6.5", name: "Canule 01 ISO 6.5", min: 1, max: 3 },
  ...
  { id: "Canule 03 ISO 9", name: "Canule 03 ISO 9", min: 0, max: 1 },
  { id: "Canule 04 ISO 10", name: "Canule 04 ISO 10", min: 0, max: 1 },
  ...
  { id: "Boîte DASRI Modèle Moyen", name: "Boîte DASRI Modèle Moyen", min: 0, max: 2 },
  { id: "Boîte DASRI Grand Modèle", name: "Boîte DASRI Grand Modèle", min: 1, max: 2 },
